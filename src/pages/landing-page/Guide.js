    ...
    const steps = [
        {
            ...
            description: `Để sử dụng dịch vụ tạo cuộc thi trực tuyến, bạn cần đăng nhập vào tài khoản của mình trên <a href="/" target="_blank" rel="noopener noreferrer" style="color: ${red[500]}; text-decoration: none;">kontest.online.vn</a><br/><br/>Bạn chưa có tài khoản? Đăng ký <a href="/sign-in" target="_blank" rel="noopener noreferrer" style="color: ${red[500]}; text-decoration: none;">tại đây</a>.`,
